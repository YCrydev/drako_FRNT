...
export const DrakoConnectButton = () => {
  ...
  return (
    <div className="">
      <div
        ...
        [&_.wallet-adapter-button-trigger]:sm:h-[40px]
        [&_.wallet-adapter-button-trigger]:sm:text-[16px]

        [&_.wallet-adapter-button-trigger]:w-[100px]
        [&_.wallet-adapter-button-trigger]:h-[25px]
        [&_.wallet-adapter-button-trigger]:text-[12px]

        [&_.wallet-adapter-button-trigger]:justify-center
        [&_.wallet-adapter-button-trigger]:rounded-[10px]
        [&_.wallet-adapter-button-trigger]:font-Lato700
        [&_.wallet-adapter-button-trigger]:text-[#583C00]
